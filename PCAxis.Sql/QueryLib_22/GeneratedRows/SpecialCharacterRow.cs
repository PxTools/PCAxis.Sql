...
namespace PCAxis.Sql.QueryLib_22
{
    ...
    public class SpecialCharacterRow
    {
        ...
        public SpecialCharacterRow(DataRow myRow, SqlDbConfig_22 dbconf, StringCollection languageCodes)
        {
    ...
    public class SpecialCharacterTexts
    {
        ...
        internal SpecialCharacterTexts(DataRow myRow, SqlDbConfig_22 dbconf, String languageCode)
        {
