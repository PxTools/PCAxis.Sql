...
namespace PCAxis.Sql.Parser_22
{
    ...
    /// </summary>
    public class PXSqlParseMetaPostData_22 : IDisposable, PCAxis.Paxiom.IPXModelParser
    {
        private static readonly ILog log = LogManager.GetLogger(typeof(PXSqlParseMetaPostData_22));
