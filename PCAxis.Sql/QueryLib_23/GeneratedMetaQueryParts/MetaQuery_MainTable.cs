...
namespace PCAxis.Sql.QueryLib_23
{
    public partial class MetaQuery
    {
        ...
        public MainTableRow GetMainTableRow(string aMainTable)
        {
            ...
            sqlString += " WHERE " + DB.MainTable.MainTableCol.Is(mSqlCommand.GetParameterRef("aMainTable"));
        ...
        private String GetMainTable_SQLString_NoWhere()
        {
            ...
            sqlString +=
                ...
                DB.MainTable.FirstPublishedCol.ForSelect() + ", " +
                DB.MainTable.SpecCharExistsCol.ForSelect() + ", " +
                DB.MainTable.SubjectCodeCol.ForSelect() + ", " +
                DB.MainTable.MetaIdCol.ForSelect() + ", " +
                DB.MainTable.ProductCodeCol.ForSelect() + ", " +
