...
namespace PCAxis.Sql.QueryLib_23
{
    ...
    {
        public static string GetValueSetExistsIn(SqlDbConfig_23 db, string lang, PxSqlCommand sqlCommand)
        {
        ...
        public static string GetGroupingExistsIn(SqlDbConfig_23 db, string lang, PxSqlCommand sqlCommand)
        {
            if (db == null) throw new ArgumentNullException("db");
