...
namespace PCAxis.Sql.QueryLib_23
{
    ...
    public class MainTableVariableRow
    {
        ...
        public static string sqlString(SqlDbConfig_23 DB)
        {

            string currentMethod = "MainTableVariableRow.sqlString";
            SqlDbConfig_23.TblSubTableVariable stv = DB.SubTableVariable;
        ...
        public MainTableVariableRow(DataRow myRow, SqlDbConfig_23 dbconf)
        {
