...

{
    ...
    public class RelevantFootNotesRow
    {
        ...
        public RelevantFootNotesRow(DataRow myRow, SqlDbConfig_23 dbconf, StringCollection languageCodes)
        {
    ...
    public class RelevantFoonotesTexts
    {
        ...
        public RelevantFoonotesTexts(DataRow myRow, SqlDbConfig_23 dbconf, String languageCode)
        {
