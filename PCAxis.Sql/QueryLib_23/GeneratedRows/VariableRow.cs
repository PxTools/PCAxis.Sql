...
namespace PCAxis.Sql.QueryLib_23
{
    ...
    public class VariableRow
    {
        ...
        public VariableRow(DataRow myRow, SqlDbConfig_23 dbconf, StringCollection languageCodes)
        {
    ...
    public class VariableTexts
    {
        ...
        internal VariableTexts(DataRow myRow, SqlDbConfig_23 dbconf, String languageCode)
        {
