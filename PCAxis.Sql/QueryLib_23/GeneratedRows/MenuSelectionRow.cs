...
namespace PCAxis.Sql.QueryLib_23
{
    ...
    public class MenuSelectionRow
    {
        ...
        public MenuSelectionRow(DataRow myRow, SqlDbConfig_23 dbconf, StringCollection languageCodes)
        {
    ...
    public class MenuSelectionTexts
    {
        ...
        internal MenuSelectionTexts(DataRow myRow, SqlDbConfig_23 dbconf, String languageCode)
        {
