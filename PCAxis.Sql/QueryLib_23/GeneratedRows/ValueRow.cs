...
namespace PCAxis.Sql.QueryLib_23
{
    ...
    public class ValueRow
    {
        ...
        public ValueRow(DataRow myRow, SqlDbConfig_23 dbconf, StringCollection languageCodes)
        {
    ...
    public class ValueTexts
    {
        ...
        internal ValueTexts(DataRow myRow, SqlDbConfig_23 dbconf, String languageCode)
        {
