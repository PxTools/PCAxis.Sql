...
namespace PCAxis.Sql.QueryLib_23
{
    ...
    public class ValueGroupRow
    {
        ...
        public ValueGroupRow(DataRow myRow, SqlDbConfig_23 dbconf, StringCollection languageCodes)
        {
    ...
    public class ValueGroupTexts
    {
        ...
        internal ValueGroupTexts(DataRow myRow, SqlDbConfig_23 dbconf, String languageCode)
        {
