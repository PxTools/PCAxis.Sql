...
namespace PCAxis.Sql.QueryLib_23
{
    ...
    public class TimeScaleRow
    {
        ...
        public TimeScaleRow(DataRow myRow, SqlDbConfig_23 dbconf, StringCollection languageCodes)
        {
    ...
    public class TimeScaleTexts
    {
        ...
        internal TimeScaleTexts(DataRow myRow, SqlDbConfig_23 dbconf, String languageCode)
        {
