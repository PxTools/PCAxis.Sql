...
namespace PCAxis.Sql.QueryLib_23
{
    ...
    public class AttributeRow
    {
        ...
        public AttributeRow(DataRow myRow, SqlDbConfig_23 dbconf, StringCollection languageCodes)
        {
    ...
    public class AttributeTexts
    {
        ...
        internal AttributeTexts(DataRow myRow, SqlDbConfig_23 dbconf, String languageCode)
        {
