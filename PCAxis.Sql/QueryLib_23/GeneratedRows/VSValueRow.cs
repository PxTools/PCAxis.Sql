...
namespace PCAxis.Sql.QueryLib_23
{
    ...
    public class VSValueRow
    {
        ...
        public VSValueRow(DataRow myRow, SqlDbConfig_23 dbconf, StringCollection languageCodes)
        {
    ...
    public class VSValueTexts
    {
        ...
        internal VSValueTexts(DataRow myRow, SqlDbConfig_23 dbconf, String languageCode)
        {
