...
namespace PCAxis.Sql.QueryLib_23
{
    ...
    public class SpecialCharacterRow
    {
        ...
        public SpecialCharacterRow(DataRow myRow, SqlDbConfig_23 dbconf, StringCollection languageCodes)
        {
    ...
    public class SpecialCharacterTexts
    {
        ...
        internal SpecialCharacterTexts(DataRow myRow, SqlDbConfig_23 dbconf, String languageCode)
        {
