...
namespace PCAxis.Sql.Parser_23
{
    ...
    /// </summary>
    public class PXSqlParseMetaPostData_23 : IDisposable, PCAxis.Paxiom.IPXModelParser
    {
        private static readonly ILog log = LogManager.GetLogger(typeof(PXSqlParseMetaPostData_23));
        ...
        internal PXSqlParseMetaPostData_23(Dictionary<string, string> inDataNoteCellEntries, Dictionary<string, StringCollection> attributeEntries, string defaultAttributes, PXSqlAttributes attributes, StringCollection languages, IEnumerable<PXSqlNpm.NPMCharacter> usedNPMCharacters, PXSqlMeta_23 meta)
        {
