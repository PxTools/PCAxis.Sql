...
namespace PCAxis.Sql.Parser_23
{
    ...
    internal class PXSqlNpm
    {
        ...
        internal PXSqlNpm(PXSqlMeta_23 mMeta)
        {
            this.mMeta = mMeta;
        ...
        internal class NPMCharacter
        {
            ...
            public NPMCharacter(KeyValuePair<string, SpecialCharacterRow> myRow, PXSqlMeta_23 mMeta)
            {
                //this.id = npmId;
        ...
        public NPMCharacter DefaultCodeMissingLineNPMCharacter
        {
            get
            {
        ...
        public NPMCharacter DataNotAvailableNPMCharacter
        {
            get
            {
                return dataNotAvailableNPMCharacter;
            }
        }
        ...
        internal NPMCharacter DataSymbolSumNPMCharacter
        {
            get
            {
                return dataSymbolSumNPMCharacter;
            }
        }
        ...
        internal NPMCharacter DataSymbolNNPMCharacter(string characterType)
        {
            if (myNPMCharacters.ContainsKey(characterType))
            {
                return myNPMCharacters[characterType];
            }
            throw new PCAxis.Sql.Exceptions.DbException(31, characterType);
        ...
        public void ParseMeta(IPXModelParser.MetaHandler handler, PXSqlMeta_23 mPXSqlMeta)
        {
