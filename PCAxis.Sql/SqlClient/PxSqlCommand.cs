...
namespace PCAxis.Sql.DbClient {
    ...
    /// </summary>
    public class PxSqlCommandForTempTables : IDisposable, PCAxis.Sql.PxSqlCommand
    {
       ...
       public string GetParameterRef(string propertyName)
       {
        ...
        private int InsertBulk(StringCollection commandStrings) {
            ...
            DbCommand pxDbCommand = myDbVendor.GetDbCommand(command);
        ...
        public string MakeTempTableJustValues(string VariableName, string VariableNumber, bool UseTemporaryTables, StringCollection valueCodes)
        {
            ...
            var tempColumnList = new List<string>();

            myDbVendor.BulkInsertIntoTemp(tempTableId, columnsTempTable, sqlString, parameters, valueCodesArray, valueCodesArray, parentCodeCounter);
        ...
        public string MakeTempTable(string VariableName, string VariableNumber, bool makeGroupFactorCol, bool UseTemporaryTables, StringCollection childCodes, StringCollection parentCodes, List<int> parentCodeCounterList)
        {
            ...
            {
                childCodesList.Add(childCodes[ValuesCounter]);
                parentCodesList.Add(parentCodes[ValuesCounter]);
            }
            ...
            tempColumnList.Add("A" + VariableName);
            tempColumnList.Add("Group" + VariableNumber);
            tempColumnList.Add("GroupNr" + VariableNumber);

            myDbVendor.BulkInsertIntoTemp(tempTableId, tempColumnList, sqlString, parameters, childCodesList.ToArray(), parentCodesList.ToArray(), parentCodeCounterList.ToArray());
