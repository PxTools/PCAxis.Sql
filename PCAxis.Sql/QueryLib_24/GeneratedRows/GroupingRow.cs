...
namespace PCAxis.Sql.QueryLib_24
{
    ...
    public class GroupingRow
    {
        ...
        public GroupingRow(DataRow myRow, SqlDbConfig_24 dbconf, StringCollection languageCodes)
        {
            ...
            this.mDefaultInGui = myRow[dbconf.Grouping.DefaultInGuiCol.Label()].ToString();
