...
namespace PCAxis.Sql.QueryLib_24
{
    ...
    public class MainTableRow
    {
        ...
        public MainTableRow(DataRow myRow, SqlDbConfig_24 dbconf, StringCollection languageCodes)
        {
    ...
    public class MainTableTexts
    {
        ...
        internal MainTableTexts(DataRow myRow, SqlDbConfig_24 dbconf, String languageCode)
        {
