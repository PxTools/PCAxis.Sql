namespace PCAxis.Sql.Parser_24
{
    ...
    public class PXSqlGroupingInfo
    {
        ...
        internal PXSqlGroupingInfo(PCAxis.Sql.QueryLib_24.GroupingRow groupingRow, DbConfig.SqlDbConfig_24.Ccodes ccodes, IEnumerable<string> valueSetIds)
        {
            ...
            */
            ...
            foreach (KeyValuePair<string, PCAxis.Sql.QueryLib_24.GroupingTexts> text in groupingRow.texts)
            {
            ...
            this.isDefault = !string.IsNullOrEmpty(groupingRow.DefaultInGui) && groupingRow.DefaultInGui == ccodes.Yes;

            this.valueSetIds.AddRange(valueSetIds);
        }
        ...
        private List<string> valueSetIds = new List<string>();

        internal IEnumerable<string> ValueSetIds
        {
            get { return valueSetIds; }
        }
        ...
        {
            get { return this.presTextByLanguage; }
        }
        //not used sorting is done in sql
