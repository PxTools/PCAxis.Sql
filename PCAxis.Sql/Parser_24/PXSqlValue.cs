...
namespace PCAxis.Sql.Parser_24
{
    ...
    public class SortByPresentationTextHelper : IComparer<PXSqlValue>
    {
        int IComparer<PXSqlValue>.Compare(PXSqlValue a, PXSqlValue b)
        {
            return a.ValueTextL[a.MainLanguageCode].CompareTo(b.ValueTextL[b.MainLanguageCode]);
        }
    }
    ...
    public class PXSqlValue : IComparable
    {
        ...
        public PXSqlValue(ValueRow2HM myValueRow, StringCollection LanguageCodes, string MainLanguageCode)
        {
            ...
            this.mMetaId = myValueRow.MetaId;
        ...
        /// <summary>
        /// Constructor to receive ValueRowHM. Used for receiving values for groups, should be used to receive all classification values in the future.
        /// </summary>
        /// <param name="myValueRow"></param>
        /// <param name="LanguageCodes"></param>
        /// <param name="MainLanguageCode"></param>
        public PXSqlValue(ValueRowHM myValueRow, StringCollection LanguageCodes, string MainLanguageCode)
        {
        ...
        public static IComparer<PXSqlValue> SortByPresentationText()
        {
            return (IComparer<PXSqlValue>)new SortByPresentationTextHelper();
        }
    }
}
