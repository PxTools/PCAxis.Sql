    ...
    public class PXSqlContent : IComparable<PXSqlContent>
    {
        ...
        public void ParseMeta(PCAxis.Paxiom.IPXModelParser.MetaHandler handler, StringCollection LanguageCodes)
        {
            ...
            if (!String.IsNullOrEmpty(this.mRow.MetaId))
            {
                ...
                handler(PXKeywords.META_ID, noLanguage, PXSqlMeta_24.mContVariableCode + "\",\"" + subkey, values);
            }
            ...
            if (!String.IsNullOrEmpty(this.mPresDecimals))
            {
                ...
                String myKey = PXSqlMeta_24.mContVariableCode + "\",\"" + subkey;//for PXModelBuilder.SplittString   A","B","C 
                                                                                 // not "A","B","C" 
        ...
        private string PaxiomifyCFPrices(string CFPrices, SqlDbConfig_24 config)
        {
            string myOut = "";
