...
namespace PCAxis.Sql.Parser_24
{
    ...
    /// </summary>
    public class PXSqlData_24 : PXSqlData
    {
        /// <summary>The Log</summary>
        private static readonly ILog log = LogManager.GetLogger(typeof(PXSqlData_24));
        ...
        #region contructors
        public PXSqlData_24(PXSqlMeta_24 mPXSqlMeta)
        {
        ...
        private string getContSelectPart(string contCode, bool Sum, bool npm)
        {
            ...
            if (npm)
            {
                ...
                PCAxis.Sql.DbConfig.SqlDbConfig_24.TblSpecialCharacter SpecialCharacter = mMeta.MetaQuery.DB.SpecialCharacter;
        ...
        private void addAttribute(PXSqlMeta_24 mMeta, DataRow sqlRow)
        {
