...
namespace PCAxis.Sql.Parser_24
{
    public class PXSqlMaintable
    {
        ...
        internal string SpecCharExists
        {
        ...
        internal string getContentsVariable(string langCode)
        {
            return mtRow.texts[langCode].ContentsVariable;
        }


        internal string ProductCode { get { return mtRow.ProductCode; } }
