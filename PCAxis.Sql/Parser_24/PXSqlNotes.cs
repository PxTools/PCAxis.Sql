...
namespace PCAxis.Sql.Parser_24
{
    ...
    internal class PXSqlNotes
    {
        ...
        internal PXSqlNotes(PXSqlMeta_24 mMeta, string mMainTableId, bool inPresentationModus)
        {
            this.mMeta = mMeta;
    ...
    abstract internal class AttachedNote
    {
        ...
        internal AttachedNote(FootnoteRow footnoteRow, PXSqlMeta_24 mMeta)
        {
        ...
        internal AttachedNote(RelevantFootNotesRow relevant, PXSqlMeta_24 mMeta)
        {
            this.codeForMandatory = mMeta.Config.Codes.FootnoteM;
        ...
        internal AttachedNote(PXSqlMeta_24 mMeta)
        {
            this.codeForMandatory = mMeta.Config.Codes.FootnoteM;
        ...
        abstract internal void ParseNote(PXSqlMeta_24 mMeta, PCAxis.Paxiom.IPXModelParser.MetaHandler handler, StringCollection langCodes);
    ...
    {
        internal TableAttachedNote(FootnoteRow footnoteRow, PXSqlMeta_24 mMeta)
            : base(footnoteRow, mMeta)
        {
        }

        internal TableAttachedNote(RelevantFootNotesRow relevant, PXSqlMeta_24 mMeta)
            : base(relevant, mMeta)
        {
        }

        internal TableAttachedNote(PXSqlMeta_24 mMeta)
            : base(mMeta)
        {
        }
        ...
        override internal void ParseNote(PXSqlMeta_24 mMeta, PCAxis.Paxiom.IPXModelParser.MetaHandler handler, StringCollection langCodes)
        {
            string keyWord;
    ...
    internal class VariableAttachedNote : AttachedNote
    {
        ...
        internal VariableAttachedNote(FootnoteRow footnoteRow, string variableCode, PXSqlMeta_24 mMeta)
            : base(footnoteRow, mMeta)
        {
        ...
        internal VariableAttachedNote(RelevantFootNotesRow relevant, PXSqlMeta_24 mMeta)
            : base(relevant, mMeta)
        {
    ...
    internal class ContentsValueAttachedNote : ValueAttachedNote
    {
        ...
        internal ContentsValueAttachedNote(RelevantFootNotesRow relevant, string variableCode, string valueCode, string contentsCode, PXSqlMeta_24 mMeta)
    ...
    internal class ValueAttachedNote : AttachedNote
    {
        ...
        internal ValueAttachedNote(FootnoteRow footnoteRow, string variableCode, string valueCode, PXSqlMeta_24 mMeta)
            : base(footnoteRow, mMeta)
        {
            this.variableCode = variableCode;
        ...
        internal ValueAttachedNote(RelevantFootNotesRow relevant, string variableCode, string valueCode, PXSqlMeta_24 mMeta)
            : base(relevant, mMeta)
        {
            this.variableCode = variableCode;
            this.valueCode = valueCode;
    ...
    internal class CellAddress
    {
        ...
        internal CellAddress(PXSqlMeta_24 mMeta)
        {
    ...
    internal class CellAttachedNote : AttachedNote
    {
        ...
        internal CellAttachedNote(FootnoteRow footnoteRow, CellAddress cell, PXSqlMeta_24 mMeta)
            : base(footnoteRow, mMeta)
        {
